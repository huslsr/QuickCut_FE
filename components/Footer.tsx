          ...
          <div className="flex flex-col md:flex-row items-center justify-between relative z-10 gap-8">
            <div className="text-center md:text-left max-w-2xl">
              ...
              <p className="text-gray-300 text-lg md:text-xl font-light leading-relaxed">
                We are building a premium mobile experience for iOS and Android. <br className="hidden md:block" /> Stay tuned for the ultimate news reading app.
              </p>
            </div>
            ...
            <div className="flex items-center gap-6 flex-shrink-0">
              ...
              <div className="flex flex-col items-center justify-center p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 w-32 h-32 hover:bg-white/10 transition-all group cursor-default">
                ...
                <span className="text-xs font-medium text-gray-400">iOS App</span>
              </div>
              ...
              <div className="flex flex-col items-center justify-center p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 w-32 h-32 hover:bg-white/10 transition-all group cursor-default">
                <svg className="w-10 h-10 text-white mb-3 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <path d="M16.71 16.71l-1.385-1.385-1.385-1.384 10.063 10.064a.997.997 0 0 0 1.414 0l-8.707-8.707z" fill="transparent" /> {/* Simplified generic android shape or triangle */}
                  <path d="M17.523 15.34l2.968 1.688c.837.476.837 1.668 0 2.144l-2.968 1.688-4.226-4.225 4.226-1.295z" />
                </svg>
                <span className="text-xs font-medium text-gray-400">Android App</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              {[
                ...
                <a key={social.name} href={social.url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-black hover:bg-gray-200 transition-all">
          ...
          <div>
            ...
            >
              ...
              <button
                type="submit"
                className={`px-4 py-2.5 rounded-lg font-semibold transition-colors text-sm ${status === 'success'
