...
export default function Home() {
    ...
    useEffect(() => {
        ...
        fetchArticles();
    }, [page, pageSize]); // Re-run when page changes
                                    ...
                                    {totalPages > 1 && (
                                        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 mt-12 mb-8 border-t border-gray-100 dark:border-gray-800 pt-8">
                                            <div className="flex items-center justify-between w-full sm:w-auto gap-4">
                                                <button
                                                    ...
                                                    disabled={page === 0}
                                                    className={`flex-1 sm:flex-none px-4 sm:px-6 py-3 border-2 border-primary font-bold uppercase tracking-widest transition-all duration-300 rounded-lg text-sm sm:text-base ${page === 0
                                        ...
                                        */}
                                                <button
                                                    ...
                                                    className={`flex-1 sm:flex-none px-4 sm:px-6 py-3 border-2 border-primary font-bold uppercase tracking-widest transition-all duration-300 rounded-lg text-sm sm:text-base sm:hidden ${page >= totalPages - 1
                                                            ? 'cursor-not-allowed bg-muted text-muted-foreground border-border'
                                                            : 'text-primary hover:bg-primary hover:text-primary-foreground hover:-translate-y-1 hover:shadow-lg shadow-sm'
                                                        }`}
                                                >
                                            ...
                                            <button
                                                onClick={() => setPage(p => Math.min(totalPages - 1, p + 1))}
                                                disabled={page >= totalPages - 1}
                                                className={`hidden sm:block px-6 py-3 border-2 border-primary font-bold uppercase tracking-widest transition-all duration-300 rounded-lg ${page >= totalPages - 1
                                                        ? 'cursor-not-allowed bg-muted text-muted-foreground border-border'
                                                        : 'text-primary hover:bg-primary hover:text-primary-foreground hover:-translate-y-1 hover:shadow-lg shadow-sm'
                                                    }`}
                                            >
